...
void returnMove(Move move){
	...
	//outputs madeMove then a space then the row then a space then the column then a line break. 
...
int main(){
	...
	bool go = true;
	while (go){ //do this forever until the makeAIShellFromInput function ends the process or it is killed by the java wrapper.
